...
- **MMESGBench** - Multimodal, multi-page document QA over real-world ESG reports. 933 expert-validated questions across 45 documents with single-page, cross-page, and unanswerable types. [Paper](https://arxiv.org/abs/2507.18932) | [Code](https://github.com/Zhanglei1103/MMESGBench)
